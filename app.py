...
if user_bomber_select == bomber_options[0]:
    ...
    sms_count = st.number_input("Enter the number of messages you want to send: ", step=1, min_value=1, max_value=500)
    delay = st.number_input("Enter the delay time: ", step=1, min_value=1)
    threads = st.number_input("Enter Number of Thread: ", step=1)
